...
markup m (DocCodeBlockHighlight hl)     = markupCodeBlockHighlight m hl
...
idMarkup = Markup {
  ...
  markupCodeBlockHighlight   = DocCodeBlockHighlight,
...
plainMarkup plainMod plainIdent = Markup {
  ...
  markupDefList              = const "",
  markupCodeBlock            = id,
  markupCodeBlockHighlight   = highlightContent,
